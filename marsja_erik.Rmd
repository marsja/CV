...
**Marsja**, E., Neely, G., Ljungberg K.J. (Accepted). Investigating deviance distraction and the impact of the modality of the to-be-ignored stimuli. *Experimental Psychology*. 
...
t.hours <- read.csv(datadir, row.names=NULL)
