...
* Ph.D. in Psychology, 2017, Department of Psychology, Umeå University.
    ...
    *Thesis title*: Attention capture by sudden and unexpected changes: a multisensory perspective. Available from the DiVA Databse: http://umu.diva-portal.org/smash/record.jsf?pid=diva2%3A1156775)
...
* B.Sc. in Cognitive Science, 2011, Department of Psychology, Umeå University.
    ...
    *Thesis title*:  Attention Capture: Studying the Distracting Effect of One’s Own Name. Available from DiVA Database: http://urn.kb.se/resolve?urn=urn:nbn:se:umu:diva-46607.
...
**Marsja**, E., Neely, G., Ljungberg K.J. (In Press). Investigating deviance distraction and the impact of the modality of the to-be-ignored stimuli. Experimental Psychology.
...
Marsh, J.E., Sörqvist, P., **Marsja**, E., Röer J.P., & Ljungberg, K.J. (Under revision).  Irrelevant vibro-tactile stimuli produce a changing-state effect: Implications for theories of interference in short-term memory.
...
a = stargazer(newdata, title='Teaching responsibilities - an overview of type of teaching, hours, etc.', notes= paste(' Total of clock hours:', total.teaching, 'UG = Undergraduate, G = Graduate', sep = ' '),  summary=FALSE, rownames=FALSE, font.size="tiny")
