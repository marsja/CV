...
# kableExtra::kbl(newdata, longtable= T, col.names = colN, format="latex", caption='Teaching responsibilities - an overview of type of teaching, hours, etc.', booktabs=TRUE) %>% 
